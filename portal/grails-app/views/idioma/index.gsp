		...
		<div id="list-idioma" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descripcion" title="${message(code: 'idioma.descripcion.label', default: 'Descripcion')}" />
				...
				<g:each in="${idiomaInstanceList}" status="i" var="idiomaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${idiomaInstance.id}">${fieldValue(bean: idiomaInstance, field: "descripcion")}</g:link></td>
