...
<body>
				...
				<div class="panel panel-default">
						...
						<div class="row">
							<div class="panel panel-primary filterable">
								...
								<table class="table table-striped table-hover">
									<thead>
										<tr class="filters">
											<th><input type="text" name="numero"
												class="form-control" placeholder="N&uacute;mero" ></th>
					...
					<div class="panel-footer" style="height: 30%;" >
						<div style="width: 100%" id="panelFooter_resolucion"></div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function getDatos(index){
	        ...
	        $.ajax({
					...
					success:function(rs){
						var list = rs.split("|");
						$("#tb_body_resolucion").html(list[0]);
							initPaginador(list[1],list[2],index);						
						if(list[2] == "0"){
							$('#panelFooter_resolucion').html("");
						}
					}
		        })
		...
		function initPaginador(cantPag,cantReg,current){
			...
			$('#panelFooter_resolucion').smartpaginator({ 
