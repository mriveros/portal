	...
	<body>
		...
		<div id="show-persona" class="content scaffold-show" role="main">
			...
			<ol class="property-list persona">
				...
				<g:if test="${personaInstance?.ci}">
				<li class="fieldcontain">
					<span id="ci-label" class="property-label"><g:message code="persona.ci.label" default="Ci" /></span>
					
						<span class="property-value" aria-labelledby="ci-label"><g:fieldValue bean="${personaInstance}" field="ci"/></span>
