	...
	<body>
		...
		<div id="show-servicio" class="content scaffold-show" role="main">
			...
			<ol class="property-list servicio">
				...
				<g:if test="${servicioInstance?.url}">
				<li class="fieldcontain">
					<span id="url-label" class="property-label"><g:message code="servicio.url.label" default="Url" /></span>
					
						<span class="property-value" aria-labelledby="url-label"><g:fieldValue bean="${servicioInstance}" field="url"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${servicioInstance?.institucion}">
				<li class="fieldcontain">
					<span id="institucion-label" class="property-label"><g:message code="servicio.institucion.label" default="Institucion" /></span>
					
						<span class="property-value" aria-labelledby="institucion-label"><g:link controller="institucion" action="show" id="${servicioInstance?.institucion?.id}">${servicioInstance?.institucion?.encodeAsHTML()}</g:link></span>
