...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'py.org.presidencia.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'py.org.presidencia.UserRole'
grails.plugin.springsecurity.authority.className = 'py.org.presidencia.Role'
grails.plugin.springsecurity.requestMap.className = 'py.org.presidencia.Requestmap'
