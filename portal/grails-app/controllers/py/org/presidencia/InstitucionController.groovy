...
class InstitucionController {
    ...
    def save(Institucion institucionInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'institucionInstance.label', default: 'Institucion'), institucionInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'institucionInstance.label', default: 'Institucion'), params.id])
                redirect action: "index", method: "GET"
            }
