...
class ServicioController {
    ...
    def save(Servicio servicioInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'servicioInstance.label', default: 'Servicio'), servicioInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'servicioInstance.label', default: 'Servicio'), params.id])
                redirect action: "index", method: "GET"
            }
